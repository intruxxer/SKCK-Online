  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown">
          <a href="<?php echo base_url('apply') ?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
              Aplikasi SKCK Baru/Perpanjangan
         ...
         <li>
           <a href="<?php echo base_url('beranda/tentangskck') ?>">Tentang SKCK</a>
         </li>
      </ul>
       <?php  $attributes = array('class' => 'navbar-form navbar-right', 'role' => 'search');
        ...
        ?>
            ...
            <button type="submit" class="btn btn-default">Cari e-SKCK</button>
         </form>
    </div><!-- /.navbar-collapse -->
