...
define('HTTP_CSS_PATH_ADMIN', $config['base_url'].'assets/scp/css/');
define('HTTP_IMAGES_PATH_ADMIN', $config['base_url'].'assets/scp/images/');
define('HTTP_JS_PATH_ADMIN', $config['base_url'].'assets/js/');
define('HTTP_FONT_AWESOME_PATH_ADMIN', $config['base_url'].'assets/font-awesome/');
...
|
*/
$config['encryption_key'] = 'Jkw6xkaoeYVNSfcHBTfzVQR71FrgDbPB';
